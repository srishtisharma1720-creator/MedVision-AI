...
<div class="hero">
<h1>🩺 MedVision AI</h1>
<h3>Chest X-Ray Pneumonia Detection</h3>
</div>
""", unsafe_allow_html=True)
...
if uploaded_file:
    ...
    fig2 = px.bar(prob_df, x="Class", y="Probability", text="Probability")
    ...
    <div class="report">
    <h2>AI Report</h2>
    <b>Diagnosis:</b> {prediction}<br><br>
    <b>Confidence:</b> {confidence_pct:.2f}%<br><br>
    <b>Note:</b> This is an AI prediction for educational use only.
    </div>
    """, unsafe_allow_html=True)
